-- made by Kurik Amudnil: http://www.bay12forums.com/smf/index.php?topic=91166.msg4336125#msg4336125

local args = {...}

local unit=df.unit.find(args[1]) or dfhack.gui.getSelectedUnit(true)

if not unit then qerror("Need a unit, aborting!") end
